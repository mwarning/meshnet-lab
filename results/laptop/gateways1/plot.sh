...
for id in 'line' 'grid4' 'rtree'; do
	gnuplot -e "
		...
		'${prefix}gateways1-babel-$id.csv' using (column('node_count')):(100 * column('packets_received') / column('packets_send')) with points linetype rgb 'dark-violet' title 'babel [%]' axis x1y2, \
		\
		...
		'${prefix}gateways1-batman-adv-$id.csv' using (column('node_count')):(100 * column('packets_received') / column('packets_send')) with points linetype rgb 'skyblue' title 'batman-adv [%]' axis x1y2, \
		\
		...
		'${prefix}gateways1-bmx6-$id.csv' using (column('node_count')):(100 * column('packets_received') / column('packets_send')) with points linetype rgb 'dark-yellow' title 'bmx6 [%]' axis x1y2, \
		\
		...
		'${prefix}gateways1-bmx7-$id.csv' using (column('node_count')):(100 * column('packets_received') / column('packets_send')) with points linetype rgb 'gold' title 'bmx7 [%]' axis x1y2, \
		\
		...
		'${prefix}gateways1-cjdns-$id.csv' using (column('node_count')):(100 * column('packets_received') / column('packets_send')) with points linetype rgb 'dark-red' title 'cjdns [%]' axis x1y2, \
		\
		...
		'${prefix}gateways1-olsr1-$id.csv' using (column('node_count')):(100 * column('packets_received') / column('packets_send')) with points linetype rgb 'coral' title 'olsr1 [%]' axis x1y2, \
		\
