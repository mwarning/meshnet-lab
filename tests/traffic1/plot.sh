...
for id in 'line' 'rtree' 'lattice4'; do
	gnuplot -e "
		...
		set termoption lw 3;																\
		plot																				\
		'traffic1-batman-adv-$id.csv' using (column('node_count')):(column('rx_bytes_per_second') / 1000 / column('node_count')) with linespoints title 'batman-adv [KB/s/node]' axis x1y1, \
		...
		\
		'traffic1-babel-$id.csv' using (column('node_count')):(column('rx_bytes_per_second') / 1000 / column('node_count')) with linespoints title 'babel [KB/s/node]' axis x1y1, \
		...
		\
		'traffic1-yggdrasil-$id.csv' using (column('node_count')):(column('rx_bytes_per_second') / 1000 / column('node_count')) with linespoints title 'yggdrasil [KB/s/node]' axis x1y1, \
		...
		\
		'traffic1-olsr2-$id.csv' using (column('node_count')):(column('rx_bytes_per_second') / 1000 / column('node_count')) with linespoints title 'olsr2 [KB/s/node]' axis x1y1, \
		...
		\
		'traffic1-bmx6-$id.csv' using (column('node_count')):(column('rx_bytes_per_second') / 1000 / column('node_count')) with linespoints title 'bmx6 [KB/s/node]' axis x1y1, \
		...
		\
		'traffic1-bmx7-$id.csv' using (column('node_count')):(column('rx_bytes_per_second') / 1000 / column('node_count')) with linespoints title 'bmx7 [KB/s/node]' axis x1y1, \
