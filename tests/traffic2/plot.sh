...
gnuplot -e "
	...
	'${prefix}traffic2-batman-adv-grid4_new.csv' using (column('node_count')):(100 * column('packets_received') / column('packets_send')) with linespoints title 'pings arrived [%]' axis x1y2;	\
"
